        ...
        <ScrollShadow className="flex-1 h-full" size={0} hideScrollBar>
          <main className="flex flex-col items-center justify-center px-4 md:px-6">
            <div className="w-full max-w-7xl mx-auto h-full flex flex-col justify-center space-y-12">
              {/* Hero Section */}
              <div className="flex flex-col justify-center max-h-[920px] min-h-[400px] h-[80svh]">
                ...
                <div className="lg:col-span-3">
                  ...
                  <div className="py-5">
                    ...
                    <p className="font-normal mt-2 text-gray-600">
                      ...
                      piecing together activities, restaurants, and routes,
                      users simply provide preferences (budget, interests,
                      travel dates). The system then creates a day-by-day plan
                      optimized for convenience, timing, and local experiences.
                    </p>
                  </div>
                </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="py-2">
                      ...
                      <p className="font-normal text-sm mt-2 text-gray-600">
                        Auto booking connects the planned itinerary directly
                        with booking services. Once a user finalizes their plan,
                        the system automatically finds and reserves flights,
                        hotels, attractions, and transport that match the
                        itinerary.
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="py-2">
                      ...
                      <p className="font-normal text-sm mt-2 text-gray-600">
                        Group planning allows friends, families, or colleagues
                        to plan trips together in a collaborative way. Members
                        can suggest destinations, vote on activities, and track
                        shared budgets. The system ensures everyone’s
                        preferences are considered and merges them into one
