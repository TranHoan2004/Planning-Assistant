...
const ItineraryDaySchema = z.object({
  ...
  attraction_recommendations: z
    .array(PlaceRecommendationSchema)
    .describe('Recommended attractions for this day'),
  restaurant_recommendations: z
    .array(PlaceRecommendationSchema)
    .describe('Recommended restaurant for this day')
})
...
export type AttractionRecommendation = z.infer<typeof PlaceRecommendationSchema>
