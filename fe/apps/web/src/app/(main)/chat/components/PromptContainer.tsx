                      ...
                      {selected === 'members' && (
                        <div className="flex flex-1 flex-col overflow-y-auto overflow-x-hidden gap-4 mx-4 mt-2">
                          <div className="flex items-center justify-between mx-3">
                            ...
                            <NumberStepper defaultValue={2} min={1} max={10} />
                          </div>
                          <Divider />
                          <div className="flex items-center justify-between mx-3">
                            <div className="flex flex-col gap-0.5">
                            ...
                            <NumberStepper defaultValue={0} min={0} max={10} />
                          </div>
                          <Divider />
                                    ...
                                    content={
                                      <div className="px-1 py-2">
                                        <div className="text-tiny">
                                          Plango sẽ giúp bạn lên kế hoạch và tìm
                                          kiếm các khách sạn thân thiện với thú
                                          cưng hơn
                                        </div>
                                      </div>
                                    }
