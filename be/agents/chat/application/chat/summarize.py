...
class SummarizeTool:
    ...
    def _create_summary_prompt(self, existing_summary: str | None) -> str:
        ...
        if existing_summary:
            ...
            user intent. Rework the summary if needed. Ensure that no critical information is lost and that the conversation
            can continue naturally without gaps. Keep the summary concise yet informative, removing unnecessary repetition while
            maintaining clarity.
            ...
            return """
            Summarize the above conversation while preserving full context, key points and user intent. Your response should be
            concise yet detailed enough to ensure seamless continuation of the discussions. Avoid redundancy, maintain clarity
            and retain all necessary details for future exchanges.
